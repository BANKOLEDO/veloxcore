  ...
  return (
    <div className="flex min-h-[calc(100vh-57px)] items-center justify-center bg-neutral-950 px-6">
      <div className="w-full max-w-sm">
        <div className="mb-8">
          <span className="font-mono text-[10px] uppercase tracking-[0.2em] text-neutral-700">welcome back</span>
        ...
        <p className="mt-6 text-center text-xs text-neutral-700">
          ...
          <Link to="/register" className="text-neutral-500 underline underline-offset-2 hover:text-white">Register</Link>
        </p>
      </div>
    </div>
  )
